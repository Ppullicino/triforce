...
## Corpus Check
- 30 files · ~23,577 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 201 nodes · 262 edges · 20 communities (12 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18d72c4f`
...
1. `Agent` - 15 edges
2. `Triforce Cross-Platform Client Plan` - 15 edges
3. `files` - 14 edges
4. `main()` - 9 edges
5. `runPipeline()` - 9 edges
6. `setupWizard()` - 7 edges
7. `runSandboxed()` - 6 edges
8. `track()` - 6 edges
9. `2026-07-15` - 6 edges
10. `resolveBinPath()` - 5 edges
...
## Knowledge Gaps
- **99 isolated node(s):** `rl`, `__dirname`, `SHARDS`, `BG`, `GOLD` (+94 more)
