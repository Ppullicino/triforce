...
## Corpus Check
- 23 files · ~18,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 154 nodes · 194 edges · 18 communities (11 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b3aabdf9`
...
Cohesion: 0.15
Nodes (14): ALLOWED_MODELS, app, computeCosts(), __dirname, httpServer, latestUsage, RATES, runInSandbox() (+6 more)
