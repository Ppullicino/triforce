...
- Next action: Scaffold the Kotlin Android project, hardened WebView/native credential
  bridge, network policy, navigation/recovery behavior, and emulator build checks.
- Known blockers: None.
